 ...
 * assests
 */
import AppleStore from "../public/images/apple-store.jpg";
import PlayStore from "../public/images/play-store-3.jpg";
        ...
        <div className="ftr-upper-flex">
          <div className="ftr-ns1">
            <div className="ftr-logo">
              <img src={"/logos/plus_logo_color.png"} alt="" />
              <div className="">
            ...
            <div className="ftr-app">
              ...
              <div className="ftr-app-stores" style={{ marginTop: "15px" }}>
                ...
                />
                <Image src={AppleStore} alt="" height="45" width="150" />
              </div>
            </div>
